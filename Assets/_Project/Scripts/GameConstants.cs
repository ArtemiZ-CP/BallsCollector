...
public class GameConstants : ScriptableObject
{
    ...
    [SerializeField] private GameplayConstants _gameplay;

    public GameplayConstants Gameplay => _gameplay;
}

[Serializable]
public struct GameplayConstants
{
    public float HeavyFigureMassMultiplier;
}
